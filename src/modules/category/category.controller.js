...
var createCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_service_1.CategoryService.createCategory(req.body)];
            case 1:
                result = _a.sent();
                res.status(201).json({
                    success: true,
...
var getAllCategories = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var search, searchString, result, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, category_service_1.CategoryService.getAllCategories({ search: searchString })];
            case 1:
                result = _a.sent();
                res.status(200).json({
                    success: true,
...
var getCategoryById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_service_1.CategoryService.getCategoryById(req.params.id)];
            case 1:
                result = _a.sent();
                res.status(200).json({
                    success: true,
...
var updateCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_service_1.CategoryService.updateCategory(req.params.id, req.body)];
            case 1:
                result = _a.sent();
                res.status(200).json({
                    success: true,
...
var deleteCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, category_service_1.CategoryService.deleteCategory(req.params.id)];
            case 1:
                _a.sent();
                res.status(200).json({
                    success: true,
